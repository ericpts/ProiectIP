"""
Django settings for colorzr project.
...
SECRET_KEY = '$g%i8h$desd1uzzg*&somp)5qg8_%onc!1l=1up(6m5ny6r2!k'
...
WSGI_APPLICATION = 'colorzr.wsgi.application'
